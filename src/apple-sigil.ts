// Source sigil for playlists that live on Apple Music, shown right-aligned on a playlist's
// count row and on the Apple rows of Add to Playlist ▸. The shape is Apple's official
// monochrome Apple Music icon (Apple_Music_Icon_blk_sm_073120.svg), path unmodified — the
// Identity Guidelines forbid the Apple logo for Apple Music. Fill is --apple-music-mark:
// the black or white file by theme, never a theme tint. Local playlists carry no badge.
export const APPLE_SIGIL =
