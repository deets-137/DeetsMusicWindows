...
const SPECS: Spec[] = [
  ...
  storeChoice("Skin settings", "glassCanvas", "Canvas", [{ value: "aurora", label: "Aurora" }, { value: "covers", label: "Covers" }, { value: "picture", label: "Picture" }], { only: "Glass only", note: skinNote("glass", "Glass") }),
  storeChoice("Skin settings", "glassTiles", "Tiles", [{ value: "one", label: "One cover" }, { value: "few", label: "Few" }, { value: "some", label: "Some" }, { value: "many", label: "Many" }], { only: "Glass only, with Canvas on Covers", note: skinNote("glass", "Glass") }),
  storeRange("Skin settings", "glassDiffusion", "Diffusion", { only: "Glass only, with Canvas on Covers or Picture", note: skinNote("glass", "Glass") }),
  storeChoice("Skin settings", "glassAuroraColor", "Aurora color", [{ value: "cover", label: "Cover" }, { value: "theme", label: "Theme" }], { only: "Glass only, with Canvas on Covers or Picture", note: skinNote("glass", "Glass") }),
