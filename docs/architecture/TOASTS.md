...
| `diary-card.ts` — a Diary write or open fails | warn | *Couldn't save that to your Diary.* / *Couldn't open “Title” in your Diary.* / *A scale's top is a number above 0.* | The last is the scale menu's own field refusing its text |
