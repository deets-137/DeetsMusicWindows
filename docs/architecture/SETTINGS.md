...
| Skin settings | Tiles (Glass only. How many album covers sit around the one that plays. One cover: it fills the window alone) — a menu of four (2026-09-24); shows with Canvas on Covers | `glassTiles` | one / few / **some** / many | `wallpaper.ts` `TILE_COUNT` (0 / 6 / 12 / 20). *One cover* is layout 1A, kept for the side-by-side desk test (COVER-WALLPAPER.md §6, step 1) |
