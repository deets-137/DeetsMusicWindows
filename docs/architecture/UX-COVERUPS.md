...
IS restored at launch ([QUEUE.md](../features/QUEUE.md) "Restore across sessions"): the first Play
...
recompose that [CARD-SWAP.md](../cards/CARD-SWAP.md) left out: the cards rise in
