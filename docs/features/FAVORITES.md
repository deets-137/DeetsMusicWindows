...
> we've touched**. Read with [DATA-ARCHITECTURE.md](../architecture/DATA-ARCHITECTURE.md) (model + cache),
...
### As it looks / works
- **The row.** Since 2026-09-10 a toggle in the **Settings card** ([SETTINGS.md](../architecture/SETTINGS.md), "Add to Library"). Until then: a `menu__row--toggle` in the title menu (`index.html`), grouped with **Always on
