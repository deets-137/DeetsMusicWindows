...
| Window | Grown card on card pick (Pick another card in a grown card's title: it keeps the size, or collapses first) — pills *Keep* / *Collapse*; last row of Window | `cardGrowPick` | **keep** / collapse | `layout.ts` `setSlot` |
