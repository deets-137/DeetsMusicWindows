...
and 500–800 ms of buffering ([UX-COVERUPS.md](UX-COVERUPS.md) §5). The skip gain covers the
...
- A toast with Undo shows under every tier ([TOASTS.md](TOASTS.md) §4). New row in §5.
